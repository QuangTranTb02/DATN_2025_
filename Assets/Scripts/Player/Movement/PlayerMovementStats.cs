...
public class PlayerMovementStats : ScriptableObject
{
    ...
    [Range(1f, 3f)] public float JumpHeightCompensationFactor = 1.054f;
    public float TimeTillJumpApex = 0.35f;
    [Range(0.01f, 5f)] public float GravityOnReleaseMultiplier = 2f;
    public float MaxFallSpeed = 20f;
    [Range(0, 5)] public int NumberOfAirAllowed = 1;
    ...
    [Range(0f, 0.5f)] public float DashDiagonalYBias = 0.4f;
...
private void CalculateValues()
{
    ...
    // Tính toán Lực Hút (Gravity)
    Gravity = -(2f * AdjustedJumpHeight) / Mathf.Pow(TimeTillJumpApex, 2f);

    // Tính toán Vận tốc Nhảy Ban đầu (Initial Jump Velocity)
